...
class Show {
    ...
    public void imprimir() {
        System.out.print(
                "=> " + this.show_id + " ## " + this.titulo + " ## " + this.tipo + " ## " + this.diretor + " ## ["
...
public class q13 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        mergeSort(vetorInseridos, 0, totalInseridos - 1);
    ...
    public static void merge(Show[] array, int esq, int meio, int dir) {
        int n1 = meio - esq + 1;
        int n2 = dir - meio;
        ...
        while (i < n1 && j < n2) {
            ...
            String durL = L[i].getDuracao().toLowerCase();
            String durR = R[j].getDuracao().toLowerCase();
        
            int cmp = durL.compareTo(durR);
        
            if (cmp < 0 || (cmp == 0 && L[i].getTitulo().compareTo(R[j].getTitulo()) < 0)) {
                array[k++] = L[i++];
            } else {
                array[k++] = R[j++];
            }
    ...
    public static int parseDuracao(String duracao) {
        if (duracao == null || duracao.equals("NaN")) return 0;
    
        try {
            duracao = duracao.toLowerCase();
    
            if (duracao.contains("season")) {
                
                return Integer.parseInt(duracao.split(" ")[0]);
            } else if (duracao.contains("min")) {
                return Integer.parseInt(duracao.split(" ")[0]);
            }
        } catch (Exception e) {
            // Valor inválido, assume como 0
        }
